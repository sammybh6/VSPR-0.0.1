...
<!-- This is the main component that will be rendered in the webview -->
...
<div class="header">
  ...
  <div class="title">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="30" height="30" viewBox="0 0 1000 1000" xml:space="preserve">
      ...
      <g transform="matrix(1.9408 0 0 1.9408 520.1258 497.3448)" id="440667">
      ...
      <g transform="matrix(0.9262 0 0 0.9262 499.9971 614.9211)" id="955253">
  ...
  <p id="hey">Document your changes into a PR using AI ✨</p>

  <button
    on:click={() => {
      tsvscode.postMessage({ type: "purpose", value: "debug message" });
    }}>Document Pull Request 🚀</button>
</div>



<!-- This button will a function that we will write in script tag and export that function-->
<!-- <button
  on:click={() => {
